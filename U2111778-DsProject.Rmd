...
We have seen how the different models have a trade-off between MSE and accuracy through overfitting or underfitting the data. The distribution of the data posed significant challenges to classification models and the categorical nature of stars posed challenges for continuous linear models. The optimal model was predictive, achieving high accuracy, and effectively managed overfitting by through bootstrapped samples. Additionally, it’s ability to handle imbalanced data contributed to its superior performance.  
